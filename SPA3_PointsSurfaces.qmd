...
```{r}
tirsfoot <- read.csv("data/SPA/SPA3/event_data_top5_leagues_18032024_(shots).csv")
dim(tirsfoot)
...
```{r}
clim <-read.csv2("data/SPA/SPA3/stations_Tunisie.csv")
```
...
```{r}
#| message: false
cafes <- st_read("data/SPA/SPA3/cafes_sousse.gpkg", quiet = TRUE)
secteurs <- st_read("data/SPA/SPA3/sousse_centre.gpkg", quiet = TRUE)
mer <- st_read("data/SPA/SPA3/sousse_mer.gpkg", quiet = TRUE)
```
